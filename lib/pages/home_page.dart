...
class HomePageState extends State<HomePage> {
  ...
  Future<void> sendFromLocal() async {
    ...
    int? i = prefs.getInt("count");
    print(i);

    // for(int k=0;k<i!;k++){
    //
    //   Map<String, dynamic> examResponseMap = {};
    //   final String? examResponseStr = prefs.getString('messageChat$i');
    ...
    //
    //   print(examResponseStr);
    //   print(exam.content);
    //
    //   prefs.remove('messageChat$i');
    //   // chatProvider.sendMessage(exam.content, exam.type, exam.groupChatId, examcurrentUserId, widget.arguments.peerId, _isConnectionSuccessful);
